...
from torchsummary import summary #  打印出网络结构 及其参数
...
./work_dirs/JujubeSSD/latest.pth
--eval bbox
--out ./work_dirs/JujubeSSD/test.pkl
--show-dir ./work_dirs/JujubeSSD/test_imgresult
"""
